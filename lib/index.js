...
function encode(hexAddress, netId) {
  ...
  if (!(hexAddress instanceof Buffer || hexAddress instanceof Uint8Array)) {
  ...
  var encodedAddress = base32.encode(
    encodeNetId(netId),
  ...
  if (verbose) {
    ...
    encodedAddress = [prefix, "type.".concat(addressType), payload]
      .join(":")
      .toUpperCase();
  }
...
function decode(address) {
  ...
  if (
    shouldHaveType !== "" &&
    "type.".concat(returnValue.type) !== shouldHaveType.toLowerCase()
  ) {
